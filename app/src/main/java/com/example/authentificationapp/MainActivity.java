...
// commande pour générer SHA-1 ==>  keytool -list -v -keystore ~/.android/debug.keystore -alias androiddebugkey -storepass android -keypass android
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showText(String topImageText, String bottomImageText) {
        ButtomFragment buttomFragment = (ButtomFragment) this.getSupportFragmentManager()
                .findFragmentById(R.id.fragment_bottom);
        buttomFragment.showText(topImageText, bottomImageText);
    }
}